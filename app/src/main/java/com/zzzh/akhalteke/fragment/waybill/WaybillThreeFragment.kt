 ...
 * @Purpose :已取消
 */
class WaybillThreeFragment : BaseFragment(), OrderContract.View {
    ...
    override fun setContentView(): Int {
        return R.layout.fragment_waybill_three
    }
    ...
    fun initAdapter() {
        ...
        mAdapter = OrderNewAdapter(mContext, DataMessageVo.ORDER_STATUS_Three, mArrayList!!)
        ...
        mAdapter!!.setOnAgreementClikcListener(object : OrderNewAdapter.OnAgreementClickItemListener {
            override fun onAgreementClickItemLisener(postion: Int, id: String, status: String, ifagrement: Boolean) {
                val bundle = Bundle()
                bundle.putString(CompletaNewAgreementActivity.ORDER_ID, id)
        ...
        mAdapter!!.setOnItemClickListener { adapter, view, position ->
            ...
            val bundle = Bundle()
            bundle.putString(OrderInfomNewNoActivity.ORDER_ID, infom.orderId)
            bundle.putString(OrderInfomNewNoActivity.TYPE, OrderInfomNewNoActivity.TYPE_THREE)
    ...
    private fun loadMoreData() {
        ...
        isRefrsh = true
        mPresenter!!.requestOrderListTwo(mContext, DataMessageVo.ORDER_STATUS_Three, mPage)
    }
    ...
    private fun loadNewData() {
        ...
        isRefrsh = true
        mPresenter!!.requestOrderListOne(mContext, DataMessageVo.ORDER_STATUS_Three, DataMessageVo.REFRESH_STARTPAGE)
    }
    ...
    fun refreshTitle(str: String) {
        MyOrderTitleVo.setCancleNumber(str)
