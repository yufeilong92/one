 ...
 * @Purpose : 已完成
 */
class WaybillTwoFragment : BaseFragment(), OrderContract.View {
    ...
    override fun setContentView(): Int {
        return R.layout.fragment_waybill_two;
    }
    ...
    fun initAdapter() {
        ...
        mAdapter = OrderNewAdapter(mContext, DataMessageVo.ORDER_STATUS_tWO, mArrayList!!)
        ...
        mAdapter!!.setOnItemClickListener { adapter, view, position ->
            ...
            bundle.putString(OrderInfomNewNoActivity.TYPE, OrderInfomNewNoActivity.TYPE_TWO)
    ...
    private fun loadMoreData() {
        ...
        isRefrsh = true
        mPresenter!!.requestOrderListTwo(mContext, DataMessageVo.ORDER_STATUS_tWO, mPage)
    }
    ...
    private fun loadNewData() {
        ...
        isRefrsh = true
        mPresenter!!.requestOrderListOne(mContext, DataMessageVo.ORDER_STATUS_tWO, DataMessageVo.REFRESH_STARTPAGE)
    }
    ...
    fun refreshTitle(str: String) {
        MyOrderTitleVo.setCompletaNumber(str)
