...
import com.zzzh.akhalteke.bean.vo.Province
...
class GmProvinceAdapter(
    var context: Context,
    var infoList: MutableList<Province>,
    var mSelectVo: MutableList<RlvSelectVo>
) :
    BaseQuickAdapter<Province, BaseViewHolder>(R.layout.item_province, infoList) {
